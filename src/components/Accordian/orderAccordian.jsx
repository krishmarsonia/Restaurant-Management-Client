...
import OrderTableRow from "../tables/orderTable/OrderTable";
...
const OrderAccordian = (props) => {
  const { item, itemHeaderArray, expanded, handleChange } = props;
            ...
            <Table>
              ...
              <TableBody>
                {item.items
                  ...
                  .map((prodItems) => {
                    return (
                      <OrderTableRow row={prodItems} key={prodItems._id} />
                    );
                  })}
              </TableBody>
            </Table>
